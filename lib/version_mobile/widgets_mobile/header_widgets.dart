...
import 'package:projet_app_walid/version_mobile/screens_mobile/contact_mobile_screen.dart';
import 'package:projet_app_walid/version_mobile/screens_mobile/profil_mobile_screen.dart';
          ...
          isMobile
                              ...
                              child: SafeArea(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    _DrawerItem(
                                      'Accueil',
                                      () => _navigate(context, const AccueilMobileScreen()),
                                      isActive: currentRoute == 'accueil',
                                    ),
                                    _DrawerItem(
                                      'Restaurants',
                                      () => _navigate(context, const RestaurantsMobileScreen()),
                                      isActive: currentRoute == 'restaurants',
                                    ),
                                    _DrawerItem(
                                      'Contact',
                                      () => _navigate(context, const ContactMobileScreen()),
                                      isActive: currentRoute == 'contact',
                                    ),
                                   
                                    _DrawerItem(
                                      'Profil',
                                      () => _navigate(context, const ProfilMobileScreen()),
              ...
              : Row(
                  children: [
                    _MenuItem(
                      label: 'Accueil',
                      onTap: () => _navigate(context, const AccueilMobileScreen()),
                      isActive: currentRoute == 'accueil',
                    ),
                    const SizedBox(width: 20),
                    _MenuItem(
                      label: 'Restaurants',
                      onTap: () => _navigate(context, const RestaurantsMobileScreen()),
                      isActive: currentRoute == 'restaurants',
                    ),
                    const SizedBox(width: 20),
                    _MenuItem(
                      label: 'Contact',
                      onTap: () => _navigate(context, const ContactMobileScreen()),
                      isActive: currentRoute == 'contact',
                    ),
                    const SizedBox(width: 20),
                    ...
                    IconButton(
                      ...
                      onPressed: () => _navigate(context, const ProfilMobileScreen()),
                    ),
                  ],
                ),
        ],
