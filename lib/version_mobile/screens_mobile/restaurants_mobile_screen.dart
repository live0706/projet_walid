...
import 'package:projet_app_walid/version_mobile/screens_mobile/chat_mobile_screen.dart';
import 'package:projet_app_walid/version_mobile/screens_mobile/reservations_mobile_screen.dart';


class RestaurantsMobileScreen extends StatefulWidget {
  const RestaurantsMobileScreen({super.key});

  @override
  State<RestaurantsMobileScreen> createState() => _RestaurantsMobileScreenState();
}

class _RestaurantsMobileScreenState extends State<RestaurantsMobileScreen> {
  ...
  Future<void> fetchRestaurants() async {
    try {
      final response =
          await http.get(Uri.parse('http://192.168.234.5:8000/restaurants'));
