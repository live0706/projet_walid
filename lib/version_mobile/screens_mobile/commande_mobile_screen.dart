...
import 'package:projet_app_walid/version_mobile/services_mobile/commande_mobile_service.dart';

class CommandeMobileScreen extends StatefulWidget {
  final List<dynamic> selectedPlats;

  const CommandeMobileScreen({super.key, required this.selectedPlats});

  @override
  State<CommandeMobileScreen> createState() => _CommandeMobileScreenState();
}

class _CommandeMobileScreenState extends State<CommandeMobileScreen> {
  ...
  children: [
    ...
    Padding(
      ...
      child: _commandeValidee
          ...
          context,
          MaterialPageRoute(
            builder: (_) => const ProfilMobileScreen(), // 👉 PAGE À CRÉER/IMPORTER
          ),
        );
                  },
