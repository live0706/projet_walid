...
import 'package:projet_app_walid/version_web/services_web/connexion_web_service.dart';
import 'package:projet_app_walid/version_web/screens_web/inscription_web_screen.dart';
import 'package:projet_app_walid/version_web/screens_web/accueil_web_screen.dart';
import 'package:shared_preferences/shared_preferences.dart';
class ConnexionWebScreen extends StatefulWidget {
  const ConnexionWebScreen({super.key});

  @override
  State<ConnexionWebScreen> createState() => _ConnexionWebScreenState();
}

class _ConnexionWebScreenState extends State<ConnexionWebScreen> {
    ...
    GestureDetector(
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (_) => const InscriptionWebScreen(), // 👉 PAGE À CRÉER/IMPORTER
          ),
        );
      },
      child: const Text(
